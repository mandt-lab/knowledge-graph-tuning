...
def define_base_learning_rate(args):
    '''Define global step and learning rate (not including global prefactor).
    ...
    with tf.variable_scope('learning_rate'):
        ...
        lr = (args.lr_offset / (step_float + args.lr_offset)) ** args.lr_exponent
